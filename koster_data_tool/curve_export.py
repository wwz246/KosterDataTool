...
def _log_export_error(logger, run_report_path: str, file_path: str, exc: Exception) -> None:
    msg = f"E9002 文件失败 file={file_path} err={exc}"
    logger.error(msg, code="E9002", file_path=file_path, error=str(exc))
...
def export_cv_block(
    ...
    try:
        ...
        _log_export_error(logger, run_report_path, file_path, exc)
        raise
